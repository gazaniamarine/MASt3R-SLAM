...
import numpy as np
import einops
from .optional_deps import MissingDependency, optional_import
imageio = optional_import('imageio', 'saving rendered images')
import matplotlib.pyplot as plt
from matplotlib.colors import ListedColormap
gym = optional_import('gym', 'the d4rl environments')
mjc = optional_import('mujoco_py', 'MuJoCo offscreen rendering')
import warnings
import pdb
...
try:
    ...
    load_environment = MissingDependency('d4rl', 'loading maze2d/locomotion environments')
